            	...
            	<div class="prikaz_card">
					<div class="card">
						<div class="card-body">
							  ...
							  <br>
							  <p>Datum i vreme: {{ manifestacija.datumIVremeOdrzavanja.date.day }}.{{ manifestacija.datumIVremeOdrzavanja.date.month }}.{{ manifestacija.datumIVremeOdrzavanja.date.year }}. u 
